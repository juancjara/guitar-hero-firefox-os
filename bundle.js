...
module.exports = About = React.createClass({
  ...
  handleClick: function(to) {
    return this.props.changeTab('About', to);
  },
  render: function() {
    var className;
    className = 'about tabs ' + this.props.show;
    return React.createElement("div", {
      "className": className
    }, React.createElement("div", {
      "className": 'btn blue pull-left',
      "onTouchEnd": this.handleClick.bind(this, 'MainMenu')
...
Dispatcher = require('./../dispatcher.coffee').Dispatcher;
...
module.exports = App = React.createClass({
  ...
  render: function() {
    return React.createElement("div", null, React.createElement(MainMenu, {
      "changeTab": this.changeTab,
      "show": this.state.tabs['MainMenu'].show
    }), React.createElement(SongList, {
      "changeTab": this.changeTab,
      "show": this.state.tabs['SongList'].show
    }), React.createElement(Help, {
      "changeTab": this.changeTab,
      "show": this.state.tabs['Help'].show
    }), React.createElement(About, {
      "changeTab": this.changeTab,
      "show": this.state.tabs['About'].show
    }), React.createElement(Game, {
      "changeTab": this.changeTab,
      "show": this.state.tabs['Game'].show
    }));
  }
});
...
Guitar = require('./../guitar.js').Guitar;

guitar = null;

module.exports = Game = React.createClass({
  getInitialState: function() {
    Dispatcher.subscribe('startGame', this.startGame);
    return {
      idx: -1,
      modalMenu: null,
      modalFinish: null,
  ...
  showText: function(obj) {
    ...
    return this.timeout = setTimeout(clearText, 500);
  },
  ...
  finishModal: function() {
    return this.state.modalFinish.trigger('openModal');
  },
  changeSong: function(modal) {
    modal.trigger('closeModal');
    return this.props.changeTab('Game', 'SongList');
  },
  resume: function() {
    this.state.modalMenu.trigger('closeModal');
    return guitar.resume();
  },
  finishGame: function(points) {
    var data;
    data = {
      points: points,
      idx: this.state.idx
    ...
    setTimeout(this.finishModal, 1000);
    return this.setState({
      points: points
    });
  },
  render: function() {
    ...
    return React.createElement("div", {
      ...
      "className": 'points'
    }, "Level Complete"), React.createElement("div", {
      "className": 'points'
    }, this.state.points, " points"), React.createElement("div", {
      "className": 'option',
      "onTouchEnd": this.changeSong.bind(null, this.state.modalFinish)
    }, "Songs list"), React.createElement("div", {
      "className": 'option',
      "onTouchEnd": this.restart.bind(null, this.state.modalFinish)
    }, "Restart")), React.createElement("div", {
      "className": 'modal menu',
      "id": 'modalMenu'
    }, React.createElement("div", {
      "className": 'option',
      "onTouchEnd": this.changeSong.bind(null, this.state.modalMenu)
    }, "Songs list"), React.createElement("div", {
      "className": 'option',
      "onTouchEnd": this.restart.bind(null, this.state.modalMenu)
    }, "Restart"), React.createElement("div", {
      "className": 'option',
...
module.exports = Help = React.createClass({
  ...
  handleClick: function(to) {
    return this.props.changeTab('Help', to);
  },
  render: function() {
    var className;
    className = 'help tabs ' + this.props.show;
    return React.createElement("div", {
      "className": className
    }, React.createElement("div", {
      "className": 'btn blue pull-left',
...
module.exports = MainMenu = React.createClass({
  componentDidMount: function() {
    return console.log('MainMenu');
  },
  handleClick: function(to) {
    return this.props.changeTab('MainMenu', to);
  },
  render: function() {
    var className;
...
SongItem = React.createClass({
  handleClick: function(idx) {
    return this.props.handleClick('Game', idx);
  },
  render: function() {
...
module.exports = SongList = React.createClass({
  getInitialState: function() {
    Dispatcher.subscribe('updatePoints', this.updatePoints);
    return {
      points: 0,
  ...
  back: function(to) {
    return this.props.changeTab('SongList', to);
  },
  handleClick: function(to, data) {
    this.back(to);
    return Dispatcher.execute('startGame', data);
  },
  updatePoints: function(data) {
    ...
    localforage.getItem('musicPoints').then(function(musicPoints) {
      musicPoints[data.idx] = data.points;
      return localforage.setItem('musicPoints', musicPoints).then(function(value) {});
    });
    this.setState({
      songs: songs,
      points: points
  ...
  componentDidMount: function() {
    var points, self, songs;
    songs = this.state.songs;
    points = 0;
    self = this;
    localforage.getItem('musicPoints', function(err, musicPoints) {
      var i;
  ...
  render: function() {
    var className;
    className = 'song-list tabs ' + this.props.show;
    return React.createElement("div", {
      "className": className
    }, React.createElement("div", {
      "className": 'btn blue pull-left',
      "onTouchEnd": this.back.bind(this, 'MainMenu')
    }, "Menu"), React.createElement("div", {
      "className": 'pull-right total-points'
    }, "Points: ", this.state.points), React.createElement("div", {
      "className": 'clear'
    }), React.createElement("h2", {
      "className": 'text-center'
    }, "Songs"), React.createElement("ul", {
      "className": 'clear-list songs'
    }, this.state.songs.map(function(item, i) {
...
module.exports.Dispatcher = {
  subscribe: function(name, fun) {
    return queue[name] = fun;
  },
  execute: function(name, params) {
    return queue[name](params);
  }
};
